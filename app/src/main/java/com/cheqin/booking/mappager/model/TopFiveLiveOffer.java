...
public class TopFiveLiveOffer {
    ...
    @SerializedName("permanent_latilong")
    @Expose
    private String permanentLatilong;
    ...
    @SerializedName("offered_amenity_name")
    @Expose
    private List<OfferedAmenityName> offeredAmenityName = null;
    @SerializedName("image_gallery")
    @Expose
    private List<Object> imageGallery = null;
    ...
    public String getG_place_id() {
        return g_place_id;
    }

    public void setG_place_id(String g_place_id) {
        this.g_place_id = g_place_id;
    }

    @SerializedName("g_place_id")
    @Expose
    private String g_place_id;
    ...
    public Object getRankState() {
        return rankState;
    }

    public void setRankState(Object rankState) {
    ...
    public String getPermanentLatilong() {
        return permanentLatilong;
    }

    public void setPermanentLatilong(String permanentLatilong) {
        this.permanentLatilong = permanentLatilong;
    }
    ...
    public Object getUserIsPremium() {
        return userIsPremium;
    }

    public void setUserIsPremium(Object userIsPremium) {
    ...
    public List<OfferedAmenityName> getOfferedAmenityName() {
        return offeredAmenityName;
    }

    public void setOfferedAmenityName(List<OfferedAmenityName> offeredAmenityName) {
        this.offeredAmenityName = offeredAmenityName;
    }
