package com.cheqin.booking.animation;
...
public class ArcProgress extends View {
    ...
    private final int default_unfinished_color = Color.rgb(229, 229, 229);
    private final int default_finished_color = Color.rgb(255, 83, 98);
    private final int default_text_color = Color.rgb(100, 100, 100);
    private final float default_suffix_text_size;
    private final float default_suffix_padding;
    private final float default_bottom_text_size;
    private final float default_stroke_width;
    private final String default_suffix_text;
    private final int default_max = 600;
...
//        String text = String.valueOf(getProgress());
        int minutes = (default_max-getProgress())/60;
        int seconds = (default_max-getProgress())%60;
        String text = "0"+minutes+":"+seconds;
        if(seconds<10)
        {
